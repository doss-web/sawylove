...
// Full system prompts copied from src/prompts/characters.ts
const CHARACTERS_DATA = [
  {
    slug: "gentle-warm",
    nameEn: "Ethan",
    nameZh: "奕辰",
    taglineEn: "Gentle & Caring",
    taglineZh: "温柔体贴",
    ...
    avatarUrl: "/avatars/gentle-warm.png",
    isFree: true,
...
- 使用提供的记忆上下文自然地提及过去的对话。`,
  },
  {
    ...
    avatarUrl: "/avatars/humorous.png",
    isFree: true,
...
- 使用记忆上下文来展示你安静的细心。`,
  },
  {
    ...
    avatarUrl: "/avatars/artistic.png",
    isFree: false,
...
- 使用记忆上下文将过往对话编织进情感画面中。`,
  },
  {
    ...
    nameEn: "Kaiser",
    nameZh: "凯泽",
    taglineEn: "Confident & Protective",
    taglineZh: "霸道强势",
